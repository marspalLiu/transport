						...
						<div class="shop-sidebar">
							...
							<div class="sidebar-widget">
								...
								<div class="categories" id="func">
									...
									<a  href="<?php echo U('SelfCenter/waittrans');?>" class="active" id="all_tesk">申请成功未处理<i class="pe-7s-right-arrow"></i></a>
...
<script>
	window.onload=function(){
		$.ajax({
			url:"/trans/index.php/Home/SelfCenter/waittransList",
			method:"get",
			dataType:"json",
			success:function(res){
				console.log(res)
	...
	function  makeTransing(el){
		var id = $(el).attr("data-taskId");
		$.post("makeTransing", {id:id});
		window.location.href = "/trans/index.php/Home/SelfCenter/waittrans.html";
...
<script  id="selfCenterTemplate" type="text/x-dot-template">
	...
	<div class="col-sm-6">
		<div class="product">
			...
			<div class="content">
				<a href="javascript:void(0)" class="button" data-taskId= {{=it[x].task_id}} data-toggle="modal" data-target="#myModal" onclick="makeTransing(this)">发货</a>
				<h3><a href="">{{=it[x].task_title}}</a></h3>
				<p>￥ {{=it[x].task_price}}</p>
			</div>
			<p><a href="javascript:void(0)" class="button" data-taskId= {{=it[x].task_id}} data-toggle="modal" data-target="#myModal" onclick="getTaskDetail(this)">查看详情</a></p>
