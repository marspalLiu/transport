								...
								<div class="shop-sidebar">
									...
									<div class="sidebar-widget">
										...
										<div class="categories" id="func">
											<a href="<?php echo U('SelfCenter/selfCenter');?>" class="active" id="all_tesk">所有任务<i class="pe-7s-right-arrow"></i></a>
...
<script>
	window.onload=function(){
		$.ajax({
			url:"/trans/index.php/Home/SelfCenter/getTaskList",
			method:"get",
			dataType:"json",
			success:function(res){
	...
	function getTaskDetail(el){
		...
		$.ajax({
           ...
           success:function(data){
               ...
               for (var i = 0; i < 4; i++) {
               	console.log(data[0]["task_pic"+(i+1)]+(i+1))
...
<script  id="selfCenterTemplate" type="text/x-dot-template">
	...
	<div class="col-sm-6">
		<div class="product">
			...
			<a href="" data-taskId="{{=it[x].task_id}}" data-toggle="modal" data-target="#myModal" onclick="getTaskDetail(this)" class="button">查看详情</a>
		</div>
	</div>
	{{ }}}
